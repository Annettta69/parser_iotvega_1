...
title = driver.find_element(By.XPATH, "/html/body/section[1]/div/div/div/div/div/h1").text
elements = driver.find_element(By.XPATH, "/html/body/section[3]/div/div/div[1]/table/tbody").text
some_el = driver.find_element(By.XPATH, "/html/body/section[3]/div/div/div[1]/table/tbody/tr[1]/td[1]").text
value = driver.find_element(By.XPATH, "/html/body/section[3]/div/div/div[1]/table/tbody/tr[1]/td[2]").text
